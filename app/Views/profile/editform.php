            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="hidden" class="form-control" id="leveluser" name="leveluser" value="<?= $level; ?>" readonly>
                        <input type="text" class="form-control" id="position" name="position" value="<?= $position; ?>" readonly>
                        <div class="levelerror invalid-feedback" style="display: None;">
                        </div>
                    </div>
                </div>
            ...
            function resetpass(id, qr) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            type: "post",
                            url: '<?= site_url('profile/resetpassword') ?>',
                            data: {
                                id: id,
                            },
                            dataType: "json",
