...
<div class="container-fluid">
    ...
    <div class="card-body">
        <?= form_open_multipart('', ['class' => 'formeditsupplier']) ?>
        <?= csrf_field(); ?>

        <div class="card-body form-group row">
            <div class="col-sm-8">
                <input type="hidden" class="form-control" id="supplierid" name="supplierid" value="<?= $supplier_id; ?>" readonly>
            </div>
        </div>
        <div class="form-group row">
            <label for="suppliername" class="col-sm-4 col-form-label">Nama Supplier</label>
            <div class="col-sm-8">
                <input type="text" class="form-control" id="suppliername" name="suppliername" value="<?= $supplier_name; ?>">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" id="supplierphone" name="supplierphone" value="<?= $supplier_phone; ?>">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                <textarea type="text" class="form-control" id="supplieraddress" name="supplieraddress" value="<?= $supplier_address; ?>"><?= $supplier_address; ?> </textarea>
...
<script>
    ...
    $('.saveButton').click(function(e) {
        ...
        let form = $('.formeditsupplier')[0];
        let data = new FormData(form);
        $.ajax({
            type: "post",
            url: "<?= site_url('supplier/updatedata'); ?>",
            data: data,
            dataType: "json",
